...
## Exclusion 1: Land already committed to public use or purpose (public or private)
...
| Dataset | Portal | Link to data |
|----|----|----|
| Connecticut CAMA and Parcel Layer | CT Geodata Portal (geodata.ct.gov) | <https://geodata.ct.gov/datasets/ctmaps::connecticut-cama-and-parcel-layer/about> |
| 2025 Connecticut Parcel and CAMA Data | CT Open Data Portal (data.ct.gov) | <https://data.ct.gov/Local-Government/2025-Connecticut-Parcel-and-CAMA-Data/rny9-6ak2/about_data> |

We have completed a statewide queried feature layer as a hosted feature layer view on ArcGIS Online using the keywords above. This can be used as a starting point for local analysis, or a new query analysis can be started on a full CAMA and parcel dataset.

| Dataset | Link |
|----|----|
| Connecticut Public Use Parcels | https://ctmaps.maps.arcgis.com/home/item.html?id=ee917ce4b44d488cbba7df730b8583dc |
...
| Dataset | Link |
|----|----|
| Education Directory | https://data.ct.gov/Education/Education-Directory/9k2y-kqxn/about_data |
...
## Exclusion 2: Open space, parks, and recreation areas dedicated to the public or protected by a conservation easement
...
5.  CT DEEP Protected Open Space (2011)
...
Land owned or permanently protected by land trusts should generally be considered protected open space and excluded from developable land inventories.

No comprehensive statewide GIS dataset exists for land trust holdings in Connecticut.

The Connecticut Land Conservation Council (CLCC) maintains a statewide directory of Connecticut land trusts that can be used to identify organizations operating within a municipality or region.

| Title | Link |
|----|----|
| CLCC Land Trust Inventory | https://ctconservation.org/what-is-a-land-trust/#maps |
...
| Dataset | Link |
|----|----|
| Connecticut Open Space Parcels | https://ctmaps.maps.arcgis.com/home/item.html?id=8264f13efc0241798d6d1c821bffc2aa |
...
##### A. State Use Description Queries
...
| Dataset | Link |
|----|----|
| DEEP Property | https://ct-deep-gis-open-data-website-ctdeep.hub.arcgis.com/datasets/CTDEEP::deep-property-3/about |
...
| Dataset | Link |
|----|----|
| 1997 Municipal and Private Open Space | https://deepmaps.ct.gov/datasets/CTDEEP::1997-municipal-and-private-open-space/about |
...
####CT Department of Agriculture Conservation Easements Link to be added once published

####USGS Protected Areas Database of the United States The USGS Protected Areas Database of the United States (PAD-US) is a national geospatial dataset that inventories protected public lands and conservation areas across the United States. The dataset includes federal, state, local, and nonprofit conservation lands, as well as lands managed for recreation, natural resource protection, open space, and other protected uses.

| Dataset | Link |
|----|----|
| USGS PAD-US | https://usgs.maps.arcgis.com/home/item.html?id=80c7a138989c4cf8937c4502371d6e99 |
...
##Exclusion 3: Land subject to enforceable restrictions or prohibitions on development This category includes land where development is legally restricted by deed, agreement, or other enforceable instruments.
...
## Exclusion 4: Wetlands or watercourses, as defined in the Wetlands and Watercourses Act (CGS Chapter 440)
...
| Dataset | Link |
|----|----|
| Soils Inland Wetland | https://geodata.ct.gov/datasets/CTDEEP::soils-inland-wetland/about |
...
| Dataset | Link |
|----|----|
| High Resolution Marsh Mapping | https://maps.cteco.uconn.edu/projects/highres_marsh/ |

::: {.callout-note appearance="simple"}
Municipalities located within Connecticut's coastal area should incorporate tidal wetland data into their developable land inventory to account for these regulated environmental resources.
:::
...
## Exclusion 5: Areas of 0.5 acres or more of contiguous land that are unsuitable for development due to topography (such as steep slopes)
...
| Dataset | Link |
|----|----|
| Connecticut Steep Slope Areas | https://geodata.ct.gov/maps/64e698b122464435a56172f576f3d2a6/about |
...
| Dataset | Link |
|----|----|
| Soils All Soils | https://geodata.ct.gov/datasets/CTDEEP::soils-all-soils/about |
...
| Dataset | Link |
|----|----|
| Bedrock Geology Set | https://geodata.ct.gov/maps/a765e96b0c05413da1dcbea0ae86707d/about |
