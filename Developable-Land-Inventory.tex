...
\item
  ...
  \bottomrule\noalign{}
  \endlastfoot
  \textless{} 1.0 & The building(s) are worth more than the land \\
  = 1.0 & Land and structures are valued equally \\
  \textgreater{} 1.0 & The land value is equal to or higher than the
  improvement value, redevelopment may be more likely \\
  \end{longtable}
  }
...
\item
  ...
  \bottomrule\noalign{}
  \endlastfoot
  \textless{} 1.0 & The building's total square footage is smaller than
  the lot. This indicates low-density development, such as single-family
  homes or suburban subdivisions. \\
  = 1.0 & The total building size is exactly equal to the lot size. This
  means you could build a one-story building covering the entire lot, or
  a two-story building covering half the lot. \\
  \textgreater{} 1.0 & The building space exceeds the lot size,
  indicating multi-story, high-density development. For example, a
  10-story building occupying 10\% of a lot yields a high FAR. \\
  \end{longtable}
  }

  To identify underperforming parcels using FAR, select a threshold at
  the lower end of the distribution, such as parcels in the bottom 10\%
  of FAR values within a neighborhood or district, as these represent
  properties where the built floor area is small relative to the land
  area, suggesting potential for more intensive development.
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.1598}}@{}}
\toprule\noalign{}
