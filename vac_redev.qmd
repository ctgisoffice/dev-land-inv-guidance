...
If using aerial imagery for review, high resoluation statewide imagery (leaf off, 4 bands, 3 inch pixel) are available for [download](https://maps.cteco.uconn.edu/download/) or through a service through CT ECO.
...
![*Example map of LTI parcels identified using the applied threshold.*](LTI_ratio.png){fig-alt="Example map of LTI parcels identified using the applied threshold." width="350"}
