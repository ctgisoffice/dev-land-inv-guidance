...
under \href{https://cga.ct.gov/2026/sup/chap_124b.htm}{CGS §§ 8-13bb and
8-13cc}. The guidance outlines the datasets, analytical methods, and
mapping standards needed to produce a consistent, statewide inventory of
developable land.
...
\href{https://cga.ct.gov/2026/sup/chap_124b.htm\#sec_8-13aa}{CGS §§
8-13aa} defines five categories of land that must be excluded from the
...
Statutes (CGS) §§ 8-13bb and 8-13cc}. The inventory identifies land that
meets the statutory definition of developable land in
\href{https://cga.ct.gov/2026/sup/chap_124b.htm\#sec_8-13aa}{CGS §§
8-13aa} and serves as a foundational input to the Housing Growth Plan
process. This guidance is intended to support a consistent and
transparent analytical approach across municipalities.
...
necessary step in preparing a Housing Growth Plan under CGS §§ 8-13bb
and 8-13cc.
...
refer to the Housing Growth Plan Guidance {[}link coming soon{]}.
...
developable land inventory under
\href{https://cga.ct.gov/2026/sup/chap_124b.htm}{CGS §§ 8-13aa, 8-13bb,
and 8-13cc}. Municipalities may use alternative data sources or
analytical approaches where appropriate, provided that the resulting
inventory is consistent with the requirements of these statutes and is
...
\href{https://cga.ct.gov/2026/sup/chap_124b.htm\#sec_8-13aa}{CGS §§
8-13aa} defines what developable land is and is not in the context of
...
of Housing Growth Plans. The statutory exclusions identified in CGS §§
8-13aa are:
...
pieces of the Housing Growth Plans, which will use \ul{suitability
analyses} {[}link coming soon{]} to complete a more detailed assessment
on capacity for future housing growth. Guidance for identifying and
analyzing vacant and potentially redevelopable land is provided in
\hyperref[0]{Section 4}.

This section outlines each statutory exclusion category, identifies
...
municipalities and ensure that the resulting outputs meet the mapping
standards described in \href{map.qmd}{Section 5}.
...
qualifying parcels and land area. Some overlap across sources is
...
We recommend utilizing the parcel dataset. The CT GIS Office aggregates
municipal parcel data annually. While locally published datasets may
also be available, the statewide aggregation is publicly accessible
through the CT Geodata Portal and the CT Housing Data Hub. This data is
not edited or transformed by the CT GIS Office; questions about data
quality or completeness should be directed to the local town assessor.
For more information on CT parcel data aggregation, see the
...
\KeywordTok{OR}\NormalTok{ STATE\_USE\_DESCRIPTION }\KeywordTok{LIKE} \StringTok{\textquotesingle{}\%RIGHTS OF WAY\%\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
spatial join operation, whereby parcels containing or intersecting point
...
inventories. No comprehensive statewide GIS dataset exists for land
trust holdings in Connecticut.The Connecticut Land Conservation Council
(CLCC) maintains a statewide directory of Connecticut land trusts that
can be used to identify organizations operating within a municipality or
region.
...
The
\href{https://ctmaps.maps.arcgis.com/home/item.html?id=8264f13efc0241798d6d1c821bffc2aa\#overview}{Connecticut
Open Space Parcels (CT Geodata Portal)} layer includes land trusts as
identified through ownership from the parcel and CAMA dataset. See the
\textbf{Parcel and CAMA Data} section below for more details.
...
\paragraph{\texorpdfstring{B. \textbf{\emph{State Use and State Use
Description
Queries}}}{B. State Use and State Use Description Queries}}\label{b.-state-use-and-state-use-description-queries-1}
...
Detailed parcel-level research on specific deed-restrictions will become
important in other parts of the Housing Growth Plan when specific sites
are being evaluated.
...
See the \textbf{Soils Inland Wetland} section above for more details on
...
\textbf{Dataset}:
\href{https://housing-ctmaps.hub.arcgis.com/maps/9afd2367671f43eaa4cf3972edd32350/about}{USA
...
{\centering \includegraphics[width=3.64583in,height=\textheight,keepaspectratio,alt={Example map of vacant parcels identified}]{Vacant_Parcels.png}
...
{\centering \includegraphics[width=3.64583in,height=\textheight,keepaspectratio,alt={Example map of brownfield site parcels identified}]{brownfields.png}
...
{\centering \includegraphics[width=3.64583in,height=\textheight,keepaspectratio,alt={Example map of LTI parcels identified using the applied threshold.}]{LTI_ratio.png}
...
{\centering \includegraphics[width=3.64583in,height=\textheight,keepaspectratio,alt={Example map of large parcels identified.}]{Relative_Size.png}
...
{\centering \includegraphics[width=3.64583in,height=\textheight,keepaspectratio,alt={Example map identifying parcels based on low FAR values.}]{FAR.png}
...
{\centering \includegraphics[width=3.125in,height=\textheight,keepaspectratio,alt={multivariate clustering box plot example}]{MultiVar2.png}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio,alt={Example Statutory Exclusions Map}]{excl_map_bordered.png}}

}

\caption{\emph{Example Statutory Exclusions Map}
\href{https://github.com/ctgisoffice/dev-land-inv-guidance/blob/master/excl_map.png?raw=true}{View
full-size map}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio,alt={Example Developable vs. Non-Developable Land Map}]{bw_map_bordered.png}}

}

\caption{\emph{Example Developable vs.~Non-Developable Land Map}
\href{https://github.com/ctgisoffice/dev-land-inv-guidance/blob/master/bw_map.png?raw=true}{View
full-size map}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio,alt={Example Developable Land Summary Map}]{summary_map_bordered.png}}

}

\caption{\emph{Example Developable Land Summary Map}
\href{https://github.com/ctgisoffice/dev-land-inv-guidance/blob/master/summary_map.png?raw=true}{View
full-size map}}
